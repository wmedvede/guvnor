...
public interface WildflyProviderConfig extends ProviderConfig {
    ...
    /**
     * Standard attribute name for setting the wildlfy user name. Pipeline inputs that wants to set the wildfly user name
     * should use this parameter name.
     */
    String WILDFLY_USER = "wildfly-user";

    /**
     * Standard attribute name for setting the wildlfy user password. Pipeline inputs that wants to set the wildfly user
