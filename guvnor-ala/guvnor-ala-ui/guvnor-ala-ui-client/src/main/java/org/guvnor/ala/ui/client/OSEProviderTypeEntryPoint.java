...
import org.guvnor.ala.ui.client.widget.provider.ose.OSEProviderConfigPresenter;
...
public class OSEProviderTypeEntryPoint {
    ...
    private final OSEProviderConfigPresenter providerConfigPresenter;
    private final NewProviderWizard newProviderWizard;

    @Inject
    public OSEProviderTypeEntryPoint( final OSEProviderConfigPresenter providerConfigPresenter,
