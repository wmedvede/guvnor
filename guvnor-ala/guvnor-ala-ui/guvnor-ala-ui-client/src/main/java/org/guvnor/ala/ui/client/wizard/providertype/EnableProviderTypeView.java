...
@Dependent
@Templated
public class EnableProviderTypeView implements IsElement,
                                               EnableProviderTypePresenter.View {

    private EnableProviderTypePresenter presenter;
    ...
    @Override
    public void init( final EnableProviderTypePresenter presenter ) {
    ...
    public String getEnableProviderTypeWizardErrorMessage() {
        return "Error when trying to enable Provider Type.";
    }

    @Override
    public String getEnableProviderTypeWizardSuccessMessage() {
        return "Provider Type enabled.";
    }
