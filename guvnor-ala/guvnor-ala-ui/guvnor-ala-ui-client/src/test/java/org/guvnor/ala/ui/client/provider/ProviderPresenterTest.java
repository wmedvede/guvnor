...
public class ProviderPresenterTest {
    ...
    private void prepareLoadProvider() {
        ...
        when(runtimeService.getRuntimesInfo(providerKey)).thenReturn(runtimeItems);
    ...
    private void verifyProviderLoaded(int currentTimes) {
        verify(providerService,
               times(currentTimes)).getProvider(providerKey);
