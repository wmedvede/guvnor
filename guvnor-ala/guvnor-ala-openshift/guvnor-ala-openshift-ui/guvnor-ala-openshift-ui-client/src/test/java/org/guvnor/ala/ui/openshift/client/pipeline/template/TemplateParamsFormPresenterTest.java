...
public class TemplateParamsFormPresenterTest {
    ...
    private static final int ALL_TEMPLATE_PARAMS_COUNT = REQUIRED_TEMPLATE_PARAMS_COUNT + NON_REQUIRED_TEMPLATE_PARAMS_COUNT;
    ...
    @Mock
    private TemplateConfigResponse templateConfigResponse;
    ...
    public void setUp() {
        ...
        when(templateConfigResponse.getModel()).thenReturn(templateDescriptorModel);
    ...
    public void testInitializeSuccessful() {
        ...
        when(openshiftClientService.getConfig(new URLConfigRequest(DEFAULT_OPEN_SHIFT_TEMPLATE_VALUE,
                                                                   ConfigType.TEMPLATE))).thenReturn(templateConfigResponse);
