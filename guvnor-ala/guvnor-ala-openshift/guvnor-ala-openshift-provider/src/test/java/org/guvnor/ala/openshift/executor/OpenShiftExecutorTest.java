...
public class OpenShiftExecutorTest {
    ...
    public void testProviderConfigReuse() throws Exception {
        ...
        OpenShiftRuntimeConfigImpl runtimeConfigA = createRuntimeConfig("testa");
        OpenShiftRuntimeConfigImpl runtimeConfigB = createRuntimeConfig("testb");
    ...
    public void testPipelineAndLifecycle() throws Exception {
        ...
        final String prjName = createProjectName("testc");
        final String appName = "myapp";
        final String svcName = appName + "-execserv";
