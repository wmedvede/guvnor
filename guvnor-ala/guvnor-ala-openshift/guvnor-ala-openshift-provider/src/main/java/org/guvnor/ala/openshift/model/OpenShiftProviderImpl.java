...
public class OpenShiftProviderImpl extends BaseProvider implements OpenShiftProvider,
                                                                   CloneableConfig<OpenShiftProvider> {

    public OpenShiftProviderImpl() {
    }

    public OpenShiftProviderImpl( final String id,
                                  final OpenShiftProviderConfig config ) {
