...
public class OpenShiftClient {
    ...
    private void createProject() {
        ...
        if (delegate.projects().withName(ns).get() == null) {
            delegate.projects().createNew().editOrNewMetadata().withName(ns)
    ...
    private void addServiceAccountRole(String name, String role) {
        String ns = getNamespace();
        Resource<PolicyBinding, DoneablePolicyBinding> bindingResource = delegate.policyBindings()
                .inNamespace(ns)
                .withName(":default");
            ...
            .addNewRoleBinding()
                ...
                .editOrNewRoleBinding()
                    .editOrNewMetadata()
                        ...
                        .withNamespace(ns)
                        .endMetadata()
                    .addToUserNames("system:serviceaccount:" + ns + ":" + name)
                    .addNewSubject()
                        .withName("default")
                        .withNamespace(ns)
            ...
            .addNewRoleBinding()
                ...
                .editOrNewRoleBinding()
                    .editOrNewMetadata()
                        ...
                        .withNamespace(ns)
                        .endMetadata()
                    .addToGroupNames("system:serviceaccounts:" + ns)
                    .addNewSubject()
                        .withName("default")
                        .withNamespace(ns)
    ...
    private void scale( String id, int count ) throws OpenShiftClientException  {
        try {
            ...
            if (service != null) {
                String dcName = service.getSpec().getSelector().get("deploymentConfig");
                if (dcName != null) {
                    DeployableScalableResource<DeploymentConfig, DoneableDeploymentConfig> dcr =
                            delegate.deploymentConfigs().inNamespace(ns).withName(dcName);
                    if (dcr != null) {
