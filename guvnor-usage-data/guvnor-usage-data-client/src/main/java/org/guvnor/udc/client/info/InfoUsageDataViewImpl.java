...
public class InfoUsageDataViewImpl extends Composite implements InfoUsageDataPresenter.InfoUsageDataEventView {
    ...
    private void initModuleColumns() {
        ...
        modulesAuditedListGrid.addColumn(moduleNameColumn, new ResizableHeader(constants.Module(), modulesAuditedListGrid,
                moduleNameColumn));
        ...
        modulesAuditedListGrid.addColumn(componentsNameColumn, new ResizableHeader(constants.Component(),
                modulesAuditedListGrid, componentsNameColumn));
